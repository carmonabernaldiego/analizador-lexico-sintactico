...
def syntactic_analysis(tokens):
    ...
    def parse_expression(tokens):
        ...
        if index < len(tokens) and tokens[index][0] == 'STRING':
            index += 1
            if index < len(tokens) and tokens[index][0] == 'OP':
                index += 1
                if index < len(tokens) and tokens[index][0] == 'NUM':
                    index += 1
                    return True
        return False
    ...
    def parse_print(tokens):
        nonlocal index
        if index < len(tokens) and tokens[index][0] == 'SYSTEM':
            index += 1
            if index < len(tokens) and tokens[index][0] == 'PARENIZQ':
                index += 1
                if parse_expression(tokens):
                    if index < len(tokens) and tokens[index][0] == 'PARENDER':
                        index += 1
                        if index < len(tokens) and tokens[index][0] == 'PUNTOCOMA':
                            index += 1
                            return True
        return False
    ...
    def parse_for(tokens):
        nonlocal index
        if index < len(tokens) and tokens[index][0] == 'FOR':
            index += 1
            if index < len(tokens) and tokens[index][0] == 'PARENIZQ':
                index += 1
                                                ...
                                                if index < len(tokens) and tokens[index][0] == 'PUNTOCOMA':
                                                    ...
                                                    if index < len(tokens) and tokens[index][0] == 'ID':
                                                        ...
                                                        if index < len(tokens) and tokens[index][0] == 'OP':
                                                            ...
                                                            if index < len(tokens) and tokens[index][0] == 'PARENDER':
                                                                index += 1
                                                                if index < len(tokens) and tokens[index][0] == 'LLAVEIZQ':
                                                                    index += 1
